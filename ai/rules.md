...
These rules apply to ALL my projects, on top of any project-specific rules.
...
1. **Read project rules first** — Always read the project's `.ai/rules/`, `.cursor/rules/`, `CLAUDE.md`, or `AI-AGENTS.md` before starting work.
